      ...
      <div  className="container">
        ...
        <div id="wd-css-class-selectors">
            ...
            <h4 className="wd-class-selector">
                This heading has same style as paragraph as above.
            </h4>
        </div>
          ...
          <div className="wd-selector-1">
            ...
            <div className="wd-selector-2">
                ...
                <p className="wd-selector-3">
                    ...
                    You can combine these relationship to create specific styles depending on the document structure
                </p>
            </div>
          </div>
        </div>
        ...
        <div id="wd-css-margins">
            ...
            <div className="wd-margin-all-around wd-padding-fat wd-border-fat
                wd-border-solid wd-border-yellow wd-bg-color-blue wd-fg-color-white">
                  Margin all around
            </div>
        </div>
        <div id="wd-css-borders">
            <h3>Rounded corners</h3>
            <p className="wd-rounded-corners-top wd-border-thin wd-border-blue
                wd-border-blue wd-border-solid wd-padding-fat">
                  Rounded corners on the top
            </p>
            <p className="wd-rounded-corners-all-around wd-border-thin wd-border-blue
                wd-border-solid wd-padding-fat">
                  Rounded corners all around
            </p>
            <p className="wd-rounded-corners-inline wd-border-thin wd-border-blue
                wd-border-solid wd-padding-fat">
        ...
        <div id="wd-css-position-relative">
            ...
            <div className = "wd-bg-color-gray">
                ...
                <div className="wd-pos-relative-nudge-up-right wd-bg-color-blue
        ...
        <div id="wd-css-position-absolute">
          ...
          <div className="wd-pos-relative">
            ...
            <div className="wd-pos-absolute-50-50 wd-bg-color-blue
              wd-fg-color-white wd-dimension-landscape">
              Landscape
            </div>
        ...
        <div id="wd-css-position-fixed">
          ...
          Checout the blue square that says "Fixed position" stuck all the way on the right and half way 
        ...
        <div id="wd-css-styling-lists">
          ...
          <ul className="list-group">
            ...
            <li className="list-group-item">Blader Runner</li>
        ...
        <div id="wd-css-hyperlink-list">
          ...
          <div className="list-group">
            <a href="https://www.en.wikipedia.org/wiki/Dune_(novel)"
        ...
        <div id="wd-css-styling-switches">
          ...
          <div className="form-check form-switch">
            <input className="form-check-input" type="checkbox"
              id="switch3" disabled />
            <label className="from-check-label" htmlFor="switch3">
